...
def perplexity(
    model, tokenizer, data_path="/work/jgtf0322/Homework/2023-Fall-ADL/HW3/dataset/public_test.json", max_length=2048,
):
...
if __name__ == "__main__":
    ...
    model.eval()
    ppl = perplexity(model, tokenizer, args.test_data_path)
